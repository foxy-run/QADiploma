...
## 4. Итоговая оценка с учётом рисков (в часах) 
- Разработка плана тестирования - 8 часов;
- Подготовка необходимых инструментов, написание кода автотестов - 86 часов;
- Подготовка отчетной документации, баг-репортов - 14 часов;
...
- Подготовка отчёта по автоматизации - 3 рабочих дня после проведения всех работ.
